...
<div class="card-body">
    ...
    <div data-content id="men_det" class="active card-body">
        ...
        <div class="form-group row">
            <div class="col-md-4">
                <label for="horizontal-firstname-input" class="col-sm-5 col-form-label">Cod. de Barra</label>
                <div class="mb-3">
                    <input type="text" id="cod_barra" value="{{$producto->cod_barra}}" name="cod_barra" class="form-control" placeholder="Ingrese el codigo">
                </div>
            </div>
            <div class="col-md-3">
                <label for="horizontal-firstname-input" class="col-sm-5 col-form-label">Ordenamiento</label>
                <div class="mb-3">
                    <input type="text" id="ordenar" value="{{$producto->ordenar}}" name="ordenar" class="form-control" placeholder="Ingrese el orden del sector">
                </div>
            </div>
        </div>
        <div class="row mb-4">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4">
                <label for="horizontal-firstname-input" class="col-sm-5 col-form-label">Unidad de medida</label>
                <select class="form-control" name="medida_id" id="medida_id">                                     
                    <option value="0" disabled>Seleccione</option>                    
                    @foreach($unidades as $uni)
                        <option value="{{$uni->id}}" @php
                                            echo ($uni->id==$medida_id)?"selected":"";
                                        @endphp>{{$uni->unidad_medida}}</option>
                    @endforeach
        ...
        <div class="form-group row">
             ...
             <div class="col-md-4">
                <label for="horizontal-firstname-input" class="col-sm-4 col-form-label">Precio Venta</label>
                <div class="mb-3">
