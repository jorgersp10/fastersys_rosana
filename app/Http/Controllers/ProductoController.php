...
class ProductoController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request){
            ...
            $unidades=DB::table('unidades_medida as uni')
            ->select('id','unidad_medida','descripcion')->get();
            ...
            "marcas"=>$marcas,"unidades"=>$unidades,$ruta,"buscarTexto"=>$sql]);
            //return $clientes;
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->medida_id==null)
            $producto->medida_id = 0;
        else
            $producto->medida_id = str_replace(".","",$request->medida_id);
    ...
    public function show($id)
    {
        ...
        'p.precio_max','p.comentarios','p.precio_mayor','p.cantidad_mayor','medida_id','cod_barra','ordenar')
        ->where('p.id','=',$id)
        ...
        "categorias"=>$categorias,"unidades"=>$unidades,"medida_id"=>$medida_id,
        "imagenes"=>$imagenes]);
